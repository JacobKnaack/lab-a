...
function multiply(a, b) { //eslint-disable-line
  ...
  var sum = a * b;
  result[0] = a * b;
  result[1] = "The product of " + a + ' and ' + b + ' is ' + sum + '.';
  return result;
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  var result1 = [];
  var sumAB = sum(a,b);
  var sumAll = sum(sumAB[0], c);
  var prodAB = multiply(a,b);
  var prodAll = multiply(prodAB[0], c);
  
  result1[0] = sumAll[0];
  result1[1] = prodAll[0];
  result1[2] = a + ' and ' + b + ' and ' + c + ' sum to ' + sumAll[0] + ".";
  result1[3] = "The product of " + a + ' and ' + b + ' and ' + c + ' is ' + prodAll[0] + '.';
  // console.log(prodAB)
  // console.log(sumAll)
  return result1;
}
...
function sumArray() { //eslint-disable-line
  var result1 = [];
  var sum01 = sum(testArray[0], testArray[1]);
  var sumAll = sum(sum01[0], testArray[2]);
  
  result1[0] = sumAll[0];
  result1[1] = testArray + ' was passed in as an array of numbers, and ' +sumAll[0]+ ' is their sum.';
...
var result1 = [];
  var sum01 = multiply(testArray[0], testArray[1]);
  var sumAll = multiply(sum01[0], testArray[2]);
  
  result1[0] = sumAll[0];
  result1[1] = 'The numbers ' + testArray + ' have a product of ' +sumAll[0]+ '.';
